  ...
  const buyNow = async () => {
    ...
    try {
      ...
      const response = await fetch("/api/checkout", {
        ...
        body: JSON.stringify({ cart: singleItemCart }),
      });
      ...
      <div className="sticky top-0 z-40 border-b border-blue-500/20 bg-[#050814]/90 px-6 py-5 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between">
          ...
          <div className="flex items-center gap-5">
            <Link
              href="/"
              className="hidden text-sm font-bold text-blue-300 hover:text-white sm:block"
            >
              ← Back to shop
            </Link>
            ...
            <div className="group relative">
              ...
              <div className="invisible absolute right-0 top-14 z-50 w-[360px] rounded-2xl border border-blue-500/20 bg-[#071225] p-5 opacity-0 shadow-[0_0_45px_rgba(37,99,235,0.25)] backdrop-blur transition-all duration-200 group-hover:visible group-hover:opacity-100">
                ...
                {cart.length === 0 ? (
                  ...
                  <>
                    ...
                    <div className="mt-5 flex items-center justify-between border-t border-blue-500/20 pt-4">
                      <span className="font-bold text-blue-100/70">Total</span>
                    ...
                    <p className="mt-2 text-xs text-blue-100/50">
                      Free shipping automatically applies over $100.
                    </p>

                    <Button
                      onClick={checkout}
                      disabled={isCheckingOut}
                      className="mt-4 h-12 w-full rounded-none bg-blue-600 font-black hover:bg-blue-500 disabled:cursor-not-allowed disabled:opacity-60"
                    >
      ...
      <main className="mx-auto max-w-7xl px-6 py-12">
        <div className="grid gap-12 lg:grid-cols-2">
          ...
          <section>
            ...
            <h1 className="mt-3 text-5xl font-black">{product.model}</h1>

            <div className="mt-4 flex gap-1 text-blue-300">
              {Array.from({ length: 5 }).map((_, index) => (
                <Star key={index} className="h-5 w-5 fill-blue-300" />
              ))}
            </div>
            ...
            <div className="mt-8 grid grid-cols-2 gap-4">
              <div className="rounded-2xl border border-blue-500/20 bg-white/5 p-4">
                ...
                <p className="font-black">24H Protection</p>
              ...
              <div className="rounded-2xl border border-blue-500/20 bg-white/5 p-4">
                ...
                <p className="font-black">14-Day Returns</p>
                <p className="mt-1 text-sm text-blue-100/60">
                  Hassle-free returns on unused items.
                </p>
              </div>
            ...
            <div className="mt-8 flex flex-col gap-4">
              ...
              <Button
                onClick={buyNow}
                disabled={isCheckingOut}
                className="h-14 rounded-none border border-blue-500/30 bg-transparent text-white hover:bg-white/10 disabled:cursor-not-allowed disabled:opacity-60"
              >
            ...
            <div className="mt-12 rounded-3xl border border-blue-500/20 bg-white/5 p-6">
              ...
              <div className="mt-6 space-y-5">
                <div className="rounded-2xl border border-blue-500/10 bg-[#08111f] p-4">
                  <p className="font-black">★★★★★ — Michael R.</p>
                  <p className="mt-2 text-blue-100/70">
                    Super clean setup and surprisingly premium quality for the
                    price.
                  </p>
                </div>

                <div className="rounded-2xl border border-blue-500/10 bg-[#08111f] p-4">
                  <p className="font-black">★★★★★ — David L.</p>
                  <p className="mt-2 text-blue-100/70">
                    Night vision quality is excellent and installation was easy.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="mt-6 space-y-5">
                <div>
                  <p className="font-black text-blue-300">
                    Does it record while parked?
                  </p>
                  <p className="mt-2 text-blue-100/70">
                    Yes, supported models include parking monitor functionality.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="mt-2 text-blue-100/70">
                    No. Most installations take under 15 minutes.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="mt-2 text-blue-100/70">
                    Yes. RoadGuard cameras support enhanced low-light recording.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="mt-5 grid gap-4 md:grid-cols-3">
            <div>
              ...
              <p className="mt-2 text-sm">
                Orders typically ship within 3–7 business days after payment
                confirmation.
              </p>
            </div>
